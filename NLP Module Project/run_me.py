...
t.score_model() # nitpick: a lot of python style guides and formatters will raise warnings for variables that are one character. better to make it translator = Translator(...) 
